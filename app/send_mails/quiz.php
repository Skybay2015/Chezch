...
$mail->Subject = 'Письмо с формы со второго блока';
$mail->Body    = '<h2>Заказан обратний звонок с формы: Второй блок</h2> <p>Номер телефона: ' .$phone. '</p> <p>Ответы: ' .$answers . '</p>';
$mail->AltBody = '';

if (isset($_POST['agreeQuiz']) && isset($phone)) {
    $mail->send();
